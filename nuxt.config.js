...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { name: 'Keywords', content: '郭庭如,塑膠廢料,資源回收,廢塑料回收,台南塑膠,台南PE塑膠,KathyKuo,PE,PE塑膠,LDPE,LDPE塑膠,LDPE塑膠回收,HDPE,HDPE塑膠,HDPE塑膠回收,再生料,PE再生料,台南再生料,展虹,展虹有限,展虹有限公司,展虹塑膠,睿虹'},
      ...
      { name: 'google-site-verification', content: 'pQLg7qjxpD1KSmx07WMEwe-MM8Ib-mpufpYwQeNyoLI' }
    ],
    link: [
